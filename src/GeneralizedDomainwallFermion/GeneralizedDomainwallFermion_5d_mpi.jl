...
"""
struct GeneralizedDomainwallFermion_5D_mpi{NC,WilsonFermion} <:
    ...
    function GeneralizedDomainwallFermion_5D_mpi(
        L5,
        NC::T,
        NX::T,
        NY::T,
...
@inline function setvalue!(
    x::GeneralizedDomainwallFermion_5D_mpi{NC,WilsonFermion},
    v,
    i1,
    i2,
    i3,
...
function Base.similar(
    ...
    return GeneralizedDomainwallFermion_5D_mpi(
        x.L5,
        NC,
        x.NX,
        x.NY,
